...
Pod::Spec.new do |s|
  s.name             = "DMLSelector"
  s.version          = "0.1.0"
  s.summary          = "A short description of DMLSelector."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/DMLSelector"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Meiliang Dong" => "dongmeilianghy@sina.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/DMLSelector.git", :tag => s.version.to_s }
