...
{
    return (self.componentDescriptor.options.count + 1) * 60;
}
...
{
    DMLSelectorOption *option = self.componentDescriptor.options[section];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = option.detailTexts[indexPath.row];
    
    if (self.values.count > 0) {
        if (indexPath.section > 0) {
            NSMutableArray *storeValues = self.values[option.masterText];
            ...
            NSString *value = self.values[option.masterText];
                                 ...
                                 atIndexPath:(NSIndexPath *)indexPath
{
    ...
    header.textLabel.text = option.masterText;
